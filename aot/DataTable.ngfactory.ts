...
export class Wrapper_DataTable {
  ...
  check_sortBy(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_1,currValue))) {
      ...
      this._changes['sortBy'] = new import1.SimpleChange(this._expr_1,currValue);
  ...
  check_sortOrder(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_2,currValue))) {
      ...
      this._changes['sortOrder'] = new import1.SimpleChange(this._expr_2,currValue);
  ...
  check_rowsOnPage(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_3,currValue))) {
      ...
      this._changes['rowsOnPage'] = new import1.SimpleChange(this._expr_3,currValue);
  ...
  check_activePage(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_4,currValue))) {
      ...
      this._changes['activePage'] = new import1.SimpleChange(this._expr_4,currValue);
  ...
  subscribe(view:import2.AppView<any>,_eventHandler:any,emit0:boolean,emit1:boolean):void {
    ...
    if (emit0) { (this.subscription0 = this.context.sortByChange.subscribe(_eventHandler.bind(view,'mfSortByChange'))); }
    if (emit1) { (this.subscription1 = this.context.sortOrderChange.subscribe(_eventHandler.bind(view,'mfSortOrderChange'))); }
  }
}